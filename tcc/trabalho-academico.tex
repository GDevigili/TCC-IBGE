...
\lstdefinelanguage{Python}{
  keywords={typeof, True, False, try, except, return, None, catch, var, if, in, while, do, else, case, break, elif, for, def, class},
...
\lstloadlanguages{JavaScript, Python}
...
\input{files/dedicatoria_agradecimentos.tex} %EDITAR
